  ...
  <section id="masterclass">
    <div class="container">
      <div class="section-header" data-reveal>
        ...
        <h2 class="section-title heading-font">Мастер-классы</h2>
...
const steps = [
  {
    ...
    desc: 'Вы получаете золото высшей 999,9 пробы и самостоятельно выбираете цвет будущих колец. Вместе с ювелиром взвешиваете металл и лигатуру, плавите до состояния раскалённой лавы и выливаете в изложницу — так рождается ваш личный слиток.',
    image: imgStep1
  },
  {
    number: '02',
  ...
  },
  {
    ...
    desc: 'Каждую заготовку сгибаете в кольцо и запаиваете шов ювелирным припоем. Один из самых волнующих моментов — металл обретает форму будущего обручального кольца прямо в ваших руках.',
    image: imgStep3
  },
  {
    number: '04',
  ...
  },
  {
    ...
    desc: 'На большой полировальной машине кольца приобретают зеркальный блеск. Завершающий штрих — ультразвуковая ванна. Вы держите в руках пару обручальных колец, созданных вашими руками.',
    image: imgStep5
  }
]
